      ...
      <div className="flex">
        ...
        >
          <div className="flex flex-1 truncate cursor-pointer items-center">
            ...
            {api.isWishlist && (
              <div className="flex font-bold rounded-full w-4 h-4 ml-2 bg-fuchsia-500 text-white items-center justify-center text-[9px]">
                W
              </div>
            )}
            {isHovered && (
          ...
          <div className="flex w-fit justify-end cursor-pointer pl-4">
            <div className={`text-sm uppercase font-medium cursor-pointer ${textClass}`}>
              {api.type}
            </div>
          </div>
        </div>
